...
export default function Post(props: Props) {
    ...
    queryKey: ['article', query.slug],
    queryFn: () => getPortfolioArticleBySlug(query.slug as string, process.env.NEXT_PUBLIC_SITE_URL as string),
  ...
  return (
	...
	<div className="w-full mx-auto space-y-4 text-center">
		...
		<h1 className="text-4xl font-bold leading-tight md:text-5xl text-skin-accent">{data?.data.name}</h1>
	...
	<div className="prose prose-pre:bg-transparent prose-pre:p-0">
